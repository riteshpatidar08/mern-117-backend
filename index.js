...
// //rename file
// fs.rename('writepost.txt' , 'writepost.json', (err)=>{
// console.log('rename success')
// })

// //unlink (delete file)
// fs.unlink('writepost.json', (err)=>{
// console.log('delete success')
// })

// //new folder 
// fs.mkdir('dashboard', (err)=>{
...
const joinedpath = path.join('dashboard' , 'users' , 'users.js') ;
console.log(joinedpath)

const filepath = path.join('dashboard','index.txt') ;
...
// ./index.js
//path module => file path findout

//finding absolute path using path.join (__filename , __dirname) ;
console.log('filename' ,__filename , 'dirname', __dirname)

//NOTE use this pattern to find out any path of file inside your project
const abpath = path.join(__dirname , 'dashboard', 'index.txt') ;
console.log(abpath)
